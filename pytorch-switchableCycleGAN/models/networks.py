...
class half_resUnet_Adain(nn.Module):
    def __init__(self, in_ch=1, out_ch=1):
        super(half_resUnet_Adain,self).__init__()
        self.inconv = inconv(in_ch = in_ch, out_ch = 64)
        self.down1 = down_half(in_ch = 64*4, out_ch=128)
        self.down2 = down_half(in_ch = 128*4, out_ch=256)
        self.down3 = down_half(in_ch = 256*4, out_ch=512)
        self.down4 = down_half_end(in_ch = 512*4, out_ch=1024)
        self.up4 = up_half(in_ch= 1024 , out_ch = 512)
        self.up3 = up_half(in_ch= 512 , out_ch = 256)
        self.up2 = up_half(in_ch= 256 , out_ch = 128)
        self.up1 = up_half(in_ch= 128 , out_ch = 64)
...
class down_half(nn.Module):
    def __init__(self,in_ch, out_ch):
        super(down_half, self).__init__()
...
class down_half_end(nn.Module):
    def __init__(self,in_ch, out_ch):
        super(down_half_end, self).__init__()
